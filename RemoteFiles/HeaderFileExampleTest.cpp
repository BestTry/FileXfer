...
int main()
{
   ...
   cout << " Yesterday I ate a nice: ";
   char l = 'a';
   cout << RecommendFood(l);

   cout << endl;

   cout << " Today I think I will eat a " << RecommendFood('b') << endl;

   string food;
   cout << " Tomorrow I think I will eat a ";
   cin >> food;

   cout << "\n Don't think, just eat a " << RecommendFood(food) << endl << endl;

   cout << " Calling an alternative function from the same Header and Implementation files \n" << endl;
